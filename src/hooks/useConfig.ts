...
const configData: Config = {
  ...
  seo: {
    title: "Tabsy Flowers | Premium Halal Meats & Groceries | Online Ordering",
    description: "Shop Tabsy Flowers for premium halal meats and groceries. Fresh flowers for every occasion. Order online for pickup or delivery today.",
